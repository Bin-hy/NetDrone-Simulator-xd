...
public class AudioManager : MonoBehaviour
{
    ...
    public static AudioManager Instance
    {
        get
        {
            if (_instance == null)
            {
                ...
                {
                    GameObject go = new GameObject(typeof(AudioManager).ToString()); // 创建一个对应的节点
    ...
    public Sound PlayMusic(string musicName, AudioClip clip, bool isLoop)
    {
        ...
        if(!soundDic.ContainsKey(musicName)) 
    ...
    /// </summary>
    /// <param name="musicName"></param>
    /// <param name="b">true播放，false暂停</param>
    /// <returns></returns>
    ...
    public void PlayOneBgMusic(AudioClip clip, bool isLoop)
    {
        StopBGM();
